...
if __name__ == '__main__':
    ...
    parser.add_argument('-in', action='store', dest='fileInput', default='/Users/JakeCordelli/Desktop/importante/recordings/0001.wav',
    ...
    parser.add_argument('-type', action='store', dest='contentType', default='audio/wav',
                        help='audio content type, for example: \'audio/l16; rate=44100\'')
    parser.add_argument('-model', action='store', dest='model', default='en-US_BroadbandModel',
